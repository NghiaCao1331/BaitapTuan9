...
public class Transaction {
    ...
    public String getTransactionSummary() {
        ...
        return "- Kiểu giao dịch: "+get_type_string(type)+". Số dư ban đầu: $"+String.format(Locale.US,"%.2f",initialBalance)+". Số tiền: $"+String.format(Locale.US,"%.2f",amount)+". Số dư cuối: $"+String.format(Locale.US,"%.2f",finalBalance)+".";
    }
}